...
public class OrderStartedDomainEvent : INotification
{
	...
	public OrderStartedDomainEvent(string userId, string userName, int orderId, string description, decimal total,
		string pickupStreet, string pickupCity, string pickupState, string pickupZip, string dropoffStreet,
		string dropoffCity, string dropoffState, string dropoffZip)
	{
		UserId = userId;
		UserName = userName;
		OrderId = orderId;
